...
<section className="allegory-page__container container mt-5 mb-5">
    <h2 className="allegory-page__container--title">Quiénes Somos</h2>
    <div className="allegory-page__content">
        <p className="allegory-page__content--p">
